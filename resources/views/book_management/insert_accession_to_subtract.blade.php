...
@section('content')
    <div class="container">
     @if(Session::has('accession'))
         <div class="alert alert-danger">{{Session::get('accession')}}</div>
         @endif
     <div class="row panel panel-primary add_student_well">
           ...
           <div class="col-md-12 well" style="margin-top:5%;">
               <form action="deleteQuantity" method="get">
               {{csrf_field()}}
                  <div class="form-group">
                       ...
                       <input type="hidden" name="quantity" value="{{$quantity}}">
                         <input type="submit" value="Subtract" name="submit" class="btn btn-primary">
                       </div>
                     </div>       
                </form>
